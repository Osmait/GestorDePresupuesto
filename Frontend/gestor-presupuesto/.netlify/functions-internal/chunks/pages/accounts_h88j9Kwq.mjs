...
import 'kleur/colors';
import 'html-escaper';
import { A as AccountRepotory, $ as $$BackArrowIcon, a as $$Layout } from './account_r5lQzPok.mjs';
import 'clsx';
/* empty css                             */
/* empty css                            */
...
const $$ListofAccounts = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section data-astro-cid-ercfeevt> <h1 data-astro-cid-ercfeevt>Accounts</h1> <table data-astro-cid-ercfeevt> <thead data-astro-cid-ercfeevt> <tr data-astro-cid-ercfeevt> <th data-astro-cid-ercfeevt>Name</th> <th data-astro-cid-ercfeevt>Bank</th> <th data-astro-cid-ercfeevt>CurrentBalance</th> </tr> </thead> <tbody data-astro-cid-ercfeevt> ${accounts && accounts.map((a) => renderTemplate`<tr data-astro-cid-ercfeevt> <td data-astro-cid-ercfeevt>${a.AccountInfo.name}</td> <td data-astro-cid-ercfeevt>${a.AccountInfo.bank}</td> <td data-astro-cid-ercfeevt>${a.CurrentBalance}</td> </tr>`)} </tbody> </table> </section> `;
