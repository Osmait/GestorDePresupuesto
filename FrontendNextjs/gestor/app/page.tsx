			...
			<div className='container mx-auto px-4'>
				<div className='flex items-center justify-between h-16'>
					...
					<div className='flex items-center gap-3'>
						...
						<Button
							asChild
							className='bg-gradient-to-r from-primary to-purple-600 hover:from-primary/90 hover:to-purple-600/90 rounded-full shadow-lg shadow-primary/25'
						>
		...
		<section ref={ref} className='relative min-h-screen flex items-center justify-center overflow-hidden'>
			...
			<motion.div style={{ y, opacity }} className='container mx-auto px-4 relative z-10'>
				<div className='text-center max-w-5xl mx-auto'>
					...
					>
						<Button size='lg' asChild className='text-lg px-8 py-7 rounded-full shadow-lg group'>
							<Link href={PROJECT_CONFIG.liveDemo}>
		...
		<section id='architecture' className='py-32 relative overflow-hidden'>
			...
			<div className='container mx-auto px-4 relative'>
				...
				>
					...
					<h2 className='text-4xl md:text-6xl font-bold mb-6'>Clean Architecture</h2>
					<p className='text-xl text-muted-foreground max-w-2xl mx-auto'>
						The backend follows Clean Architecture principles with clear separation of concerns. Dependencies point
						inward, keeping the core domain independent of frameworks.
					</p>
				</motion.div>
		...
		<section id='patterns' className='py-32 relative'>
			<div className='container mx-auto px-4'>
				...
				>
					...
					<h2 className='text-4xl md:text-6xl font-bold mb-6'>Patterns Implemented</h2>
					<p className='text-xl text-muted-foreground max-w-2xl mx-auto'>
...
function TechStackSection() {
	const frontend = [
		...
		{
			name: 'React 18',
			description: 'Concurrent Features & Hooks',
			logo: (
				<svg viewBox='0 0 24 24' fill='currentColor' className='w-6 h-6'>
					<path d='M14.23 12.004a2.236 2.236 0 0 1-2.235 2.236 2.236 2.236 0 0 1-2.236-2.236 2.236 2.236 0 0 1 2.235-2.236 2.236 2.236 0 0 1 2.236 2.236zm2.648-10.69c-1.346 0-3.107.96-4.888 2.622-1.78-1.653-3.542-2.602-4.887-2.602-.41 0-.783.093-1.106.278-1.375.793-1.683 3.264-.973 6.365C1.98 8.917 0 10.42 0 12.004c0 1.59 1.99 3.097 5.043 4.03-.704 3.113-.39 5.588.988 6.38.32.187.69.275 1.102.275 1.345 0 3.107-.96 4.888-2.624 1.78 1.654 3.542 2.603 4.887 2.603.41 0 .783-.09 1.106-.275 1.374-.792 1.683-3.263.973-6.365C22.02 15.096 24 13.59 24 12.004c0-1.59-1.99-3.097-5.043-4.032.704-3.11.39-5.587-.988-6.38-.318-.184-.688-.277-1.092-.278zm-.005 1.09v.006c.225 0 .406.044.558.127.666.382.955 1.835.73 3.704-.054.46-.142.945-.25 1.44-.96-.236-2.006-.417-3.107-.534-.66-.905-1.345-1.727-2.035-2.447 1.592-1.48 3.087-2.292 4.105-2.295zm-9.77.02c1.012 0 2.514.808 4.11 2.28-.686.72-1.37 1.537-2.02 2.442-1.107.117-2.154.298-3.113.538-.112-.49-.195-.964-.254-1.42-.23-1.868.054-3.32.714-3.707.19-.09.4-.127.563-.132zM12 8.1c.74 0 1.477.034 2.202.093.406.582.802 1.203 1.183 1.86.372.64.71 1.29 1.018 1.946-.308.655-.646 1.31-1.013 1.95-.38.66-.773 1.288-1.18 1.87-.728.063-1.466.098-2.21.098-.74 0-1.477-.035-2.202-.093-.406-.582-.802-1.204-1.183-1.86-.372-.64-.71-1.29-1.018-1.946.303-.657.646-1.313 1.013-1.954.38-.66.773-1.286 1.18-1.868.728-.064 1.466-.098 2.21-.098z' />
				</svg>
			),
		},
		{
		...
		},
		{
			...
			logo: (
				<svg viewBox='0 0 25 25' fill='currentColor' className='w-6 h-6'>
	...
	const backend = [
		...
		},
		{
			...
			logo: (
				<svg viewBox='0 0 24 24' fill='currentColor' className='w-6 h-6'>
					<path d='M5.025 7.377c-.046-.287.092-.54.31-.56.218-.02.436.192.483.479.047.287-.092.54-.31.56-.218.02-.436-.193-.483-.479m4.406-.746c-.047-.287.092-.54.31-.56.218-.02.436.193.483.479.046.287-.093.54-.31.56-.219.02-.437-.192-.484-.479M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2m3.5 14.5c-2.333 1-4.667 1-7 0-.417-.167-.583-.5-.5-.917.167-.833.5-1.583 1-2.25.333-.417.75-.333 1.083 0 .667.667 1.417 1 2.417 1s1.75-.333 2.417-1c.333-.333.75-.417 1.083 0 .5.667.833 1.417 1 2.25.083.417-.083.75-.5.917' />
				</svg>
			),
		},
		{
		...
		<section id='tech-stack' className='py-32 relative overflow-hidden'>
			...
			<div className='container mx-auto px-4 relative'>
				...
				>
					...
					<h2 className='text-4xl md:text-6xl font-bold mb-6'>Technologies Used</h2>
					<p className='text-xl text-muted-foreground max-w-2xl mx-auto'>
		...
		<section id='highlights' className='py-32 relative'>
			<div className='container mx-auto px-4'>
				...
				>
					...
					<h2 className='text-4xl md:text-6xl font-bold mb-6'>Key Implementations</h2>
					<p className='text-xl text-muted-foreground max-w-2xl mx-auto'>
						...
						<CardContent className='p-0'>
							...
							<div className='p-8 md:p-12'>
								...
								<div className='bg-muted/50 rounded-xl p-4 mb-8 font-mono text-sm overflow-x-auto'>
									...
									<code className='text-primary'>git clone {PROJECT_CONFIG.repository}.git</code>
								</div>
