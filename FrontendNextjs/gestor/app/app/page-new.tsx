...
import { DataLoader } from '@/components/client/data-loader'
...
// Componente principal - Server Component que usa DataLoader
export default function DashboardPageNew() {
	return (
		<DataLoader>
			{({ user, accounts, transactions, categories, budgets, isLoading, error }) => {
				if (isLoading) {
					...
					<div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/30 dark:from-background dark:via-background dark:to-muted/20">
						<div className="container mx-auto px-4 py-8">
							...
							<TabsController 
								...
								className="space-y-6"
								listClassName="grid w-full grid-cols-4 lg:w-auto lg:grid-cols-4 bg-muted/50 dark:bg-muted/30"
							/>
