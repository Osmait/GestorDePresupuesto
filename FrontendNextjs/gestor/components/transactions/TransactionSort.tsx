...
export function TransactionSort() {
    ...
    const currentSortLabel = () => {
        if (filters.sortBy === 'amount') return filters.sortOrder === 'desc' ? 'Monto: Mayor a Menor' : 'Monto: Menor a Mayor'
        if (filters.sortBy === 'transaction_name') return filters.sortOrder === 'asc' ? 'Nombre: A-Z' : 'Nombre: Z-A'
        return filters.sortOrder === 'asc' ? 'Fecha: Antigua' : 'Fecha: Reciente'
    }
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuGroup>
                    <DropdownMenuLabel className="text-xs text-muted-foreground font-normal">Fecha</DropdownMenuLabel>
                ...
                <DropdownMenuSeparator />
                <DropdownMenuGroup>
                    <DropdownMenuLabel className="text-xs text-muted-foreground font-normal">Monto</DropdownMenuLabel>
                ...
                <DropdownMenuSeparator />
                <DropdownMenuGroup>
                    <DropdownMenuLabel className="text-xs text-muted-foreground font-normal">Nombre</DropdownMenuLabel>
