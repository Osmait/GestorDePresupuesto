	...
	useEffect(() => {
		if (editingTransaction) {
			form.reset({
				...
				type_transaction:
					editingTransaction.type_transation === 'income' ? TypeTransaction.INCOME : TypeTransaction.BILL,
									...
									<FormItem>
										...
										<FormControl>
											<Select
												...
												disabled={selectedAccountType === 'bank'}
											>
												<SelectTrigger>
										...
										selectedAccountId &&
										cardCurrenciesLoaded &&
										cardCurrencies.length === 0 ? (
