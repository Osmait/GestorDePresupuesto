...
import { AlertTriangle, DollarSign, PiggyBank, TrendingDown, TrendingUp } from 'lucide-react'
			...
			<CardContent>
				<div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
					...
					<div className='text-center p-4 rounded-lg bg-gradient-to-br from-green-500/10 to-emerald-500/10 dark:from-green-500/5 dark:to-emerald-500/5'>
						...
						<p
							className={`text-xl font-bold ${totalRemaining >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}
						>
