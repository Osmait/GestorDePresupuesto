...
import { Certificate, InterestType, CreateCertificateDTO, UpdateCertificateDTO } from '@/types/certificate'
...
interface CertificateFormModalProps {
	...
	onSimulate?: (data: { capital: number; rate: number; taxRate: number; interestType: InterestType; reinvestInterest: boolean }) => void
}
					...
					<div className="grid gap-4 py-4">
						...
						<div className="grid grid-cols-4 items-center gap-4">
							...
							<Input
								...
								placeholder="0.00"
							/>
							{errors.base_capital && <p className="col-span-4 text-right text-sm text-red-500">{errors.base_capital.message}</p>}
						</div>
						...
						<div className="grid grid-cols-4 items-center gap-4">
							...
							<Select
								value={interestType}
								onValueChange={(value) => setValue('interest_type', value as InterestType)}
							>
						...
						<div className="grid grid-cols-4 items-center gap-4">
							...
							<Input
								...
								placeholder="4.55"
							/>
							{errors.current_interest_rate && <p className="col-span-4 text-right text-sm text-red-500">{errors.current_interest_rate.message}</p>}
						</div>
						...
						<div className="grid grid-cols-4 items-center gap-4">
							...
							<Input
								...
								placeholder="10.00"
							/>
							{errors.current_tax_rate && <p className="col-span-4 text-right text-sm text-red-500">{errors.current_tax_rate.message}</p>}
						</div>
