...
import { ArrowDownCircle, ArrowUpCircle, CalendarClock, Edit, MoreHorizontal, Trash } from 'lucide-react'
...
} from '@/hooks/queries/useRecurringTransactionsQuery'
			...
			<Card className='text-center py-12'>
				<CardContent>
					...
					<p className='text-muted-foreground'>
						Configura tus gastos o ingresos fijos para que se generen automáticamente.
					</p>
				</CardContent>
			</Card>
		)
					...
					<CardContent>
						...
						<div className='flex justify-between items-center text-xs text-muted-foreground'>
							...
							{item.last_execution_date && (
								<span>Última ej: {format(new Date(item.last_execution_date), 'dd/MM/yyyy')}</span>
							)}
						</div>
					</CardContent>
				</Card>
